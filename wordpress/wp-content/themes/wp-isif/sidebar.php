  ...
  <aside id="sidebar">
    ...
    <form method="get" class="sidebar_search" name="searchform" action="<?php bloginfo('url'); ?>/">
      ...
      <input type="submit" class="search_submit" name="Поиск" value="Найти"/>
    </form>

    <!-- Feedburner begin -->
    <div class="feedburner">
      <form class="burner_form" method="post" action="№" target="_blank" name="SR_form_4_90">
      ...
      <div class="burner_rss">
        <span class="burner_icon" title="Подписка по RSS" cursor:pointer;"><img src="<?php echo get_template_directory_uri(); ?>/img/burner_rss.jpg "></span>
             RSS-Подписка<br>
             <span class="grey_count ">6178 читателей</span>
        </div>
        <div class="burner_twit ">
             <a class="burner_icon " target="_blank "  rel="author " title="Следуй за мной в Google+ "><img src="<?php echo get_template_directory_uri(); ?>/img/google-plus.png " alt=" "></a>
             Google+<br>
